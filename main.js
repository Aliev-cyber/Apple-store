...
const API = "http://localhost:8012/products";
...
async function getData() {
  const res = await fetch(`${API}?_limit=${limit}&_page=${currentPage}&category_like=${category}`);
...
document.querySelector("#add-form").addEventListener("click", async function () {
